...
When the interaction term is included, the significance of the predictor variables are improved overall.
...
There seems to be patterns in residuals to the autorrelation in the form of a serial correlation in the data. we cannot explain with all variance in NHPI with the predictors here. We may need more variables for a more complete model.
