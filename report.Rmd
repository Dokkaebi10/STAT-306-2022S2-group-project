...
The VIFs CPI and Earnings is larger than 10, and therefore, the collinearity between them may be a problem.
...
The model 2 is very far off with its predictions. The more complicated models are more conservative, and has wide prediction intervals.
