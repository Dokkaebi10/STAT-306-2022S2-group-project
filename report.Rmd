...
```
Therefore, the model suggests the 5-year mortgage rate to achieve the minimum NHPI is `r round(interest.at.min, 3)` %. This is unintuitive as home price is expected to continue to decline with higher interest rates.
